...
export default function AssessPage() {
  const [signalId, setSignalId] = useState("mrs_");
  ...
  const [message, setMessage] = useState("Paste a registered mrs_* signal ID to request validator assessment.");
  ...
  return (
    <main className="mx-auto min-h-screen max-w-3xl px-5 py-10 text-[#161814]">
      ...
      <p className="mt-3 max-w-2xl text-lg leading-8 text-[#596452]">
        ...
        commitment, and finalize a mrv_* risk verdict.
      </p>
